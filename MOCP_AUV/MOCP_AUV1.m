...
% Vehicle (AUV)
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.AUV.num = 6; % AUV的数量
            obj.AUV.cruise = [2.31, 2.35, 2.16, 2.27, 2.09, 2.43]; % 最大巡航速度
            obj.AUV.initialBattery = [13.37, 14.49, 14.87, 14.60, 14.66, 14.69]; % 初始可用能量12-15 kJ
            obj.AUV.startPos = [0 50 -50; 16.6667 0 -50; 83.3333 0 -50; 100 50 -50; 83.3333 100 -50; 16.6667 100 -50]; %%% 起始点
            obj.AUV.goalPos = [100 50 -50; 83.3333 100 -50; 16.6667 100 -50; 0 50 -50; 16.6667 0 -50; 83.3333 0 -50]; %%% 目标点
