...
% Vehicle (AUV)
    ...
    methods
        ...
        function Setting(obj)
            % Parameter setting
            obj.AUV.num = 10; % AUV的数量
            obj.AUV.cruise = [2.31, 2.35, 2.16, 2.27, 2.09, 2.43, 2.45, 2.02, 2.15, 2.32]; % 最大巡航速度
            obj.AUV.initialBattery = [13.37, 14.49, 14.87, 14.60, 14.66, 14.69, 14.39, 13.34, 14.40, 12.21]; % 初始可用能量12-15 kJ
            obj.AUV.startPos = [0 100 -80; 0 95 -80; 0 90 -80; 0 85 -80; 5 100 -80; 5 95 -80; 5 90 -80; 10 100 -80; 10 95 -80; 15 100 -80]; %%% 起始点
            obj.AUV.goalPos = [100 0 -20; 100 5 -20; 100 10 -20; 100 15 -20; 95 0 -20; 95 5 -20; 95 10 -20; 90 0 -20; 90 5 -20; 85 0 -20]; %%% 目标点
        ...
        function R = GetOptimum(obj,~)
            R = [139.12, 318.82, 127.92] * 1.1; % 参考点
        end
    end
end
