...
% 指定文件夹的路径
folders = {'DRCMODEO1', 'DRCMODEO2', 'DRCMODEO3', 'DRCMODE'};
Algorithm_name = {'DR-CMODE-O1', 'DR-CMODE-O2', 'DR-CMODE-O3', 'DR-CMODE'};

Problem_name = {'MOCP_AUV1', 'MOCP_AUV2', 'MOCP_AUV3', 'MOCP_AUV4'};

Numbers = 10; % 记录数据点数
Colors = [170, 71, 188;76, 176, 80;255, 140, 0;30, 144, 255;170, 71, 188;76, 176, 80;255, 140, 0;30, 144, 255;]./255;
% % 生成 n 种颜色的 HSV 值
